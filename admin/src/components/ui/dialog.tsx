...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 w-[min(92vw,30rem)] -translate-x-1/2 -translate-y-1/2 rounded-[28px] border border-white/10 bg-[var(--panel)] p-6 shadow-[0_30px_80px_rgba(0,0,0,0.45)]",
        className,
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("font-serif text-2xl text-[var(--foreground)]", className)} {...props} />
));
